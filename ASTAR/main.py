...
right_side.configure(background=rgbtohex(25,73,114))
...
def create_grid():
    ...
    find = Button(right_side, height=3, width=15, text="Start Pathfinding", font=("Arial", 15), command=find_quickest)

    find.grid(padx=30, pady=15)

    clear = Button(right_side, height=3, width=15, text="Clear grid", font=("Arial", 15), command=erase)
    clear.grid(padx=30)
